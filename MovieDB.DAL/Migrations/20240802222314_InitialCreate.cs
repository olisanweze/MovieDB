    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MoviePlayLists", x => new { x.PlayListId, x.MovieId });
                    table.ForeignKey(
                        name: "FK_MoviePlayLists_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Poster = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    MoviePlayListMovieId = table.Column<int>(type: "int", nullable: true),
                    MoviePlayListPlayListId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Movies", x => x.MovieId);
                    table.ForeignKey(
                        name: "FK_Movies_MoviePlayLists_MoviePlayListPlayListId_MoviePlayListMovieId",
                        columns: x => new { x.MoviePlayListPlayListId, x.MoviePlayListMovieId },
                        principalTable: "MoviePlayLists",
                        principalColumns: new[] { "PlayListId", "MovieId" });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MovieName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    UserName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    Star = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Movies_MoviePlayListPlayListId_MoviePlayListMovieId",
                table: "Movies",
                columns: new[] { "MoviePlayListPlayListId", "MoviePlayListMovieId" });
